...
namespace application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                Environment.SetEnvironmentVariable("DB_CONNECTION", "Server=localhost;Port=3306;Database=CourseApi_Integration;Uid=root;Pwd=DevSysth2025@;");
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    TermsOfService = new Uri("https://mrinfo.inf.br/"),
                    Contact = new OpenApiContact
                    {
                        Name = "Zucco",
                        Email = "eduardo@gmail.com",
                        Url = new Uri("https://mrinfo.inf.br/")
                    },
