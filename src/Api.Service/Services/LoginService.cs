...
namespace Api.Service.Services
{
    public class LoginService : ILoginService
    {
        ...
        public async Task<object> FindByLogin(LoginDto user)
        {
            ...
            if (user != null && !string.IsNullOrWhiteSpace(user.Email))
            {
                ...
                else
                {
                    ...
                    return SuccessObject(token, createDate, expirationDate, baseUser);
                }
            }
        ...
        private object SuccessObject(string token, DateTime createDate, DateTime expirationDate, UserEntity user)
        {
            return new
            {
                authenticated = true,
